...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat height = self.controlRadius*(1.0-VOLUME_CONTROL_CENTER_OFFSET_PERCENT_Y);
     ...
     UIImage *volumeImg = [UIImage imageNamed:@"turquoisevolume"];
    CGRect volumeRect = CGRectMake(self.controlCenter.x-23.0,
                                   self.controlCenter.y+22.5, 28, 28);
...
//                                   self.controlCenter.y-volumeImg.size.height/2-15.0, volumeImg.size.width, volumeImg.size.height);
    ...
    UIImage *max_snd = [UIImage imageNamed:@"volume-1"];
