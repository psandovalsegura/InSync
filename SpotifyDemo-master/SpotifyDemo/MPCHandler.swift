...
class MPCHandler: NSObject, MCSessionDelegate {
    ...
    /*
     Method to notify all peers that a track has been added
     */
//    func notifyPeersTrackAdded() {
//        let key = "queue-key"
//        let keyData = key.dataUsingEncoding(NSUTF8StringEncoding)
//        
//        do {
//            try session.sendData(keyData!, toPeers: session.connectedPeers, withMode: MCSessionSendDataMode.Reliable)
